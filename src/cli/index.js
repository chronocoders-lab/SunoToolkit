...
program
    ...
    .action(() => {
        ...
        console.log(chalk.white('• Node.js Versiyonu: ') + chalk.green(process.version));
        console.log(chalk.white('• Platform: ') + chalk.green(process.platform));
        console.log(chalk.white('• Bellek Kullanımı: ') + chalk.green(Math.round(process.memoryUsage().heapUsed / 1024 / 1024) + ' MB'));
